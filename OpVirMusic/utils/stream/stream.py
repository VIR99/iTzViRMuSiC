...
import config
from OpVirMusic import Carbon, YouTube, app
from OpVirMusic.core.call import OpVirMusic
from OpVirMusic.misc import db
from OpVirMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from OpVirMusic.utils.exceptions import AssistantErr
from OpVirMusic.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from OpVirMusic.utils.inline.playlist import close_markup
from OpVirMusic.utils.pastebin import OpVirbin
from OpVirMusic.utils.stream.queue import put_queue, put_queue_index
from OpVirMusic.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await OpVirMusic.force_stop_stream(chat_id)
