...
from OpVirMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from OpVirMusic.core.call import OpVirMusic
from OpVirMusic.utils import seconds_to_min, time_to_seconds
from OpVirMusic.utils.channelplay import get_channeplayCB
from OpVirMusic.utils.database import is_video_allowed
from OpVirMusic.utils.decorators.language import languageCB
from OpVirMusic.utils.decorators.play import PlayWrapper
from OpVirMusic.utils.formatters import formats
from OpVirMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from OpVirMusic.utils.database import is_served_user
from OpVirMusic.utils.inline.playlist import botplaylist_markup
from OpVirMusic.utils.logger import play_logs
from OpVirMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await OpVirMusic.stream_call(url)
...
@app.on_callback_query(
    filters.regex("OpVirMusicymousAdmin") & ~BANNED_USERS
)
async def OpVirMusicymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("OpVirMusicPlaylists") & ~BANNED_USERS
)
@languageCB
