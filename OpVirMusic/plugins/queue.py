...
from OpVirMusic.utils import (OpVirbin, get_channeplayCB,
                              seconds_to_min)
from OpVirMusic.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from OpVirMusic.utils.decorators.language import language, languageCB
from OpVirMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/9912be7bdd20a99c2bf23.png",
        caption=_["queue_1"],
    )
